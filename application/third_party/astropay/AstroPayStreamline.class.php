...
class AstroPayStreamline {
	 ...
	 **************************/
	private $x_login = 'YIVgtLkT4c';
	private $x_trans_key = 'su1HcAfmXm';
	
	private $x_login_for_webpaystatus = 'eGQajIm2W6';
	private $x_trans_key_for_webpaystatus = 'cEsYuwwSCw';
	
	private $secret_key = 'te4QZabbxpLKuwuUJvHTkvvr8PxWm3LML';
